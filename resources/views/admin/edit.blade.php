...
<head>
    ...
    <title>Editar Filme - Admin</title>
    <style>
        :root {
            --bg-dark: #141414;
            --bg-light: #1f1f1f;
...
<body>
    <header>🎬 Capybara Cinema - Editar Filme</header>
    <main>
        <h1>Editar Filme</h1>
        <form action="{{ route('admin.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id">
                    ...
                    <option value="{{ $category['id'] }}" @if($movie->category->id == $category['id']) selected @endif>
                        {{ $category['name'] }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="link" id="link" value="{{ $movie->link }}">
            </div>
